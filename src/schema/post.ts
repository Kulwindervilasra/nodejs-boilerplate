...
builder.queryFields((t) => ({
    ...
    draftsByUser: t.prismaField({
        ...
        resolve: (query, parent, args) => prisma.user
            .findUnique({
                where: {
...
builder.mutationFields((t) => ({
    createDraft: t.prismaField({
        ...
        resolve: (query, parent, args) => prisma.post.create({
            ...query,
            data: {
    ...
    incrementPostViewCount: t.prismaField({
        ...
        resolve: (query, parent, args) => prisma.post.update({
            ...query,
            where: { id: args.id },
            data: {
    ...
    deletePost: t.prismaField({
        ...
        resolve: (query, parent, args) => prisma.post.delete({
            ...query,
            where: { id: args.id },
        }),
    }),
